...
Generate API Key and encryption keys to then be added in the "TusPagos Payment Gateway Option", then activate the payments inside the Woocommerce configuration
